...
get_decoding_main_model_results_graph(cfg, paths)
```
...
get_decoding_main_model_results_diff_graph(cfg, paths)
plot_decoding_main_model_results_diff(cfg, paths, roi_input = "visual")
plot_decoding_main_model_results_diff(cfg, paths, roi_input = "visual", graph_input = TRUE)
```
