...
prepare_data_behavior_sequence_previous(cfg, paths)
prepare_data_behavior_sequence_dist_prev(cfg, paths)
...
```{r}
source(here::here("code", "behavior", "zoo-analysis-behavior-single.R"))
```
...
get_behavior_sequence_dist_run(cfg, paths)
get_behavior_sequence_dist_run_glm(cfg, paths)
...
```{r}
get_questionnaire_random_transitions(cfg, paths, graphs)
...
plot_questionnaire_prob_model(cfg, paths)
```
...
plot_sr_matrices_select_extreme(cfg, paths)
```

```{r}
get_behavior_sequence_onestep_run(cfg, paths)
get_behavior_sequence_onestep_run_glm(cfg, paths)
get_behavior_sr_fit_response_time_onestep(cfg, paths)
get_behavior_sr_fit_response_time_onestep_diff(cfg, paths)
...
plot_sr_modeling_parameter_recovery(cfg, paths)
```
...
prepare_data_decoding_single_interval(cfg, paths)
```
...
get_decoding_main_model_residuals_slope_mean(cfg, paths)
get_decoding_main_model_residuals_slope_stat(cfg, paths)
...
```{r}
get_decoding_main_model_residuals_mean(cfg, paths, group = "alpha_group")
get_decoding_main_model_residuals_mean(cfg, paths, group = "gamma_group")
get_decoding_main_model_residuals_mean(cfg, paths, group = "sequence_detected")
get_decoding_main_model_residuals_mean(cfg, paths, group = "surprise_group")
get_decoding_main_model_residuals_mean(cfg, paths, group = "rating_group")
get_decoding_main_model_residuals_mean(cfg, paths, group = "knowledge_group")
```
...
```{r}
get_decoding_main_model_residuals_slope_mean_group(cfg, paths, group = "alpha_group")
get_decoding_main_model_residuals_slope_mean_group(cfg, paths, group = "gamma_group")
get_decoding_main_model_residuals_slope_mean_group(cfg, paths, group = "sequence_detected")
get_decoding_main_model_residuals_slope_mean_group(cfg, paths, group = "surprise_group")
get_decoding_main_model_residuals_slope_mean_group(cfg, paths, group = "rating_group")
get_decoding_main_model_residuals_slope_mean_group(cfg, paths, group = "knowledge_group")
...
get_decoding_main_model_residuals_slope_stat_group(cfg, paths, group = "rating_group")
get_decoding_main_model_residuals_slope_stat_group(cfg, paths, group = "knowledge_group")
dt_output <- get_decoding_main_model_residuals_slope_stat_group(cfg, paths, group = "surprise_group") %>%
  .[roi == "visual", ] %>%
  .[graph == "uni"] %>%
  .[p.value < 0.05] %>%
  .$report_latex
...
```{r}
get_decoding_main_model_betas_id(cfg, paths)
la = get_decoding_main_model_betas_behav(cfg, paths) %>%
  .[sr_parameter == "gamma", ] %>%
  .[graph == "uni", ]
get_decoding_main_model_betas_behav_cor_mean(cfg, paths)
get_decoding_main_model_betas_behav_cor_mean_stat(cfg, paths)
```
...
```{r}
get_decoding_main_model_residuals_rt_cor(cfg, paths)
get_decoding_main_model_residuals_rt_cor_stat(cfg, paths)
plot_decoding_main_model_residuals_rt_cor(cfg, paths)
```
...
plot_decoding_main_residuals_slope_alpha_gamma(cfg, paths, roi_input = "visual", graph_input = "uni")
plot_decoding_main_residuals_slope_awareness(cfg, paths, roi_input = "visual", graph_input = "uni")
plot_brain_behavior(cfg, paths, roi_input = "visual")
```
